...
**Answer** Import `patients.csv.gz` as a tibble `patients_tble`.
...
According to the pie chart, there are more male than female patients.
...
Using the violin plot to show the summary of the length of ICU stay by marital status
...
I will dot plot to show the relationship between the length of ICU stay and each last available lab measurements before ICU stay.
```{r}
#| eval: true
