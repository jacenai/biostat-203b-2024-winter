...
final_classification <- final_classification |>
  mutate(.pred_class = as.factor(ifelse(.pred_TRUE > .pred_FALSE, "TRUE", "FALSE")))
...
```
From the plot above, it is clear that for 9
the most important features in predicting long ICU stays are the 
following: 
