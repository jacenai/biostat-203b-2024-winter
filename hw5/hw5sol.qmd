...
forest model. Then, tune the model using 5-fold cross-validation. (1)
...
model. Then, tune the model using 5-fold cross-validation. (1) define
...
# First, convert the predicted probabilities to predicted classes
