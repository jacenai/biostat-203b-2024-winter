...
-   Do not put auxiliary files into version control.
    ...
    `.DS_Store` is included in Git and other unnecessary files are still there. `-5.0`
...
-   [Rule 2.2.2](https://style.tidyverse.org/syntax.html#parentheses) Do not place spaces around code in parentheses or square brackets. Place a space before left parenthesis, except in a function call.
    ...
    No violations. Note that texts inside and outside chunks are not related to 80-character rule.
